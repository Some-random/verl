...
log_dir=$PWD/logs/feedback_rl_${timestamp}
mkdir -p $log_dir
...
# Use SFT checkpoint trained on feedback tool usage
model_path=$HDFS_ROOT/checkpoint/feedback-sft-qwen-2.5-7b-instruct/global_step_78/huggingface
...
experiment_name=qwen2.5-7b_feedback_rl
...
train_batch_size=32  # Reduced to avoid overloading feedback server
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.total_epochs=3 $@ 2>&1 | tee $log_dir/training.log
