...
log_dir=$PWD/logs/feedback_rl_qwen3_8b_full_${timestamp}
mkdir -p $log_dir
...
experiment_name=qwen3-8b-sft_feedback_rl_full
...
# 8B model - full fine-tuning (no LoRA)
train_batch_size=32  # Can handle this with 8B model
